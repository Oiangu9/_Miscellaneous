...
This version of the code shows the animation in real time
...
def run_N_Body_simulator(N, positions_now, velocities_now, masses, additional_parameters,
    ...
    # constant to avoid repeated calculation
    ...
    for it, t in enumerate(times):
        ...
        # Plot the particles
        if it%plotEvery==0:
            plot_N_particles(fig, positions, velocities_next, t,
...
def plot_N_particles(fig, positions, velocities, t, xmin=-1, xmax=1, ymin=-1, ymax=1, zmin=-1, zmax=1):
    fig.clf()
